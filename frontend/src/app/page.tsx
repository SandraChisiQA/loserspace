          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center justify-between w-full lg:hidden">
              ...
              <button
                ...
                className="p-2 rounded-full bg-[#FF9E3D] hover:bg-[#FF8C1A] text-black transition-all duration-200 cursor-pointer"
              >
            ...
            {isLoading ? (
              ...
              <div>
                {posts.map((post, index) => (
                  <article key={post.id} className="border-b border-gray-200 hover:bg-gray-50/50 transition-all duration-200 group">
                    <div className="flex p-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Link href={`/posts/${post.id}?category=${currentCategory}`} className="block cursor-pointer">
                          {/* Post Title */}
                          <h2 className="text-lg font-semibold text-gray-900 mb-4 group-hover:text-[#FF9E3D] transition-colors duration-200 line-clamp-2">
                            {post.title}
                          </h2>
